...
const log = debug("bscnjs:contract")

const { logDecoder } = require("bscnjs-ethjs-abi") as IETHABI
...
export interface IContractSendRequestOptions {
  /**
   * The amount in BSCN to send. eg 0.1, default: 0
   */
  ...
  /**
   * Bscn price per gas unit, default: 0.00000001, min:0.00000001
   */
  gasPrice?: number | string

  /**
   * The bscn address that will be used as sender.
   */
...
export class Contract {
   ...
   *      [solar](https://github.com/BSCN-Project/solar). It includes the contract
  ...
  /**
   * Executes contract method on your own local bscnd node as a "simulation"
